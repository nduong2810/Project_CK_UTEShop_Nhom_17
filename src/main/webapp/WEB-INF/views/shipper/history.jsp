...
<%-- 
    ...
    2. Sử dụng màu sắc và icon phù hợp.
    3. Cải thiện hiển thị trạng thái và ngày giờ.
--%>
...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-header bg-success text-white p-3 rounded-top-4 d-flex align-items-center justify-content-between">
            ...
            <span class="badge bg-light text-success fs-6 fw-bold">${fn:length(requestScope.historyOrders)} Đơn đã xong</span>
        </div>
        ...
        <div class="card-footer text-center bg-light text-muted small py-3 rounded-bottom-4">
            <i class="fas fa-archive me-1"></i> Đây là nơi lưu trữ hồ sơ công việc đã hoàn thành.
        </div>
    </div>
</div>