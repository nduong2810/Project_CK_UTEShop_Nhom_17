...
<title>UTESHOP Admin • Nhà cung cấp</title>
<link
					...
					<tbody>
						<c:forEach var="s" items="${suppliers}" varStatus="i">
							<tr>
								...
								<td>${s.diaChi}</td>
								<td><span
									class="badge bg-${s.trangThai?'success':'secondary'}">${s.trangThai?'Hoạt động':'Tạm dừng'}</span></td>
								<td class="text-end"><a
									class="btn btn-sm btn-outline-secondary"
									href="${pageContext.request.contextPath}/admin/suppliers/view?id=${s.maCH}"><i
