	...
	<div class="container-fluid py-2 px-3">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav me-auto">
				<!-- Trang chủ -->
				<li class="nav-item"><a
					class="nav-link ${fn:contains(pageContext.request.requestURI, '/home') ? 'active' : ''}"
					href="${pageContext.request.contextPath}/guest/home"> <i
						class="fas fa-home me-1"></i>Trang chủ
				</a></li>
				<!-- Sản phẩm với dropdown danh mục -->
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle ${fn:contains(pageContext.request.requestURI, '/product') ? 'active' : ''}"
					href="#" id="productsDropdown" role="button"
					data-bs-toggle="dropdown"> <i class="fas fa-box me-1"></i>Sản
						phẩm
				</a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item"
							href="${pageContext.request.contextPath}/guest/home?showAll=true">
						...
						<c:if test="${not empty applicationScope.categories}">
							<c:forEach var="cat" items="${applicationScope.categories}">
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/guest/category?id=${cat.maDM}">
										<i class="fas fa-tag me-2"></i>${cat.tenDM}
								</a></li>
							</c:forEach>
						</c:if>
						<c:if test="${empty applicationScope.categories}">
							<li><span class="dropdown-item-text text-muted">Chưa
									có danh mục</span></li>
						</c:if>
					</ul></li>
				<!-- Nhà cung cấp -->
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle ${fn:contains(pageContext.request.requestURI, '/supplier') ? 'active' : ''}"
					href="#" id="suppliersDropdown" role="button"
					data-bs-toggle="dropdown"> <i class="fas fa-industry me-1"></i>Nhà
						cung cấp
				</a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item"
							href="${pageContext.request.contextPath}/guest/suppliers"> <i
								class="fas fa-building me-2"></i>Danh sách nhà cung cấp
						</a></li>
					</ul></li>
				<!-- Đơn vị vận chuyển -->
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle ${fn:contains(pageContext.request.requestURI, '/shipping') ? 'active' : ''}"
					href="#" id="shippingDropdown" role="button"
					data-bs-toggle="dropdown"> <i class="fas fa-truck me-1"></i>Vận
						chuyển
				</a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item"
							href="${pageContext.request.contextPath}/guest/shipping/policy">
								<i class="fas fa-file-alt me-2"></i>Chính sách vận chuyển
						</a></li>
						<li><a class="dropdown-item"
							href="${pageContext.request.contextPath}/guest/shipping/track">
								<i class="fas fa-search-location me-2"></i>Tra cứu đơn hàng
						</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item"
							href="${pageContext.request.contextPath}/guest/shipping/partners">
			...
			<div class="d-flex align-items-center gap-2">
				...
				<a href="${pageContext.request.contextPath}/user/cart"
					class="btn btn-outline position-relative cart-icon"
					title="Xem giỏ hàng"> <i class="fas fa-shopping-cart"></i> <span
					class="cart-count position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"
					id="cartCount"> <c:choose>
							<c:when
								test="${not empty sessionScope.cartCount and sessionScope.cartCount > 0}">
				...
				<c:choose>
					<c:when test="${not empty sessionScope.user}">
						...
						<div class="dropdown">
							<button
								class="btn btn-outline dropdown-toggle d-flex align-items-center"
							...
							<ul class="dropdown-menu dropdown-menu-end">
								...
								<li>
									<h6 class="dropdown-header">
										...
										${sessionScope.user.hoTen} <small class="d-block text-muted">${sessionScope.userRole}</small>
									</h6>
								</li>
								<li><hr class="dropdown-divider"></li>
								...
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/user/profile"> <i
										class="fas fa-user-edit me-2"></i>Hồ sơ cá nhân
								</a></li>
								<li><a class="dropdown-item"
								...
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/user/favorites"> <i
										class="fas fa-heart me-2"></i>Sản phẩm yêu thích
								</a></li>
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/user/viewed"> <i
										class="fas fa-heart me-2"></i>Sản phẩm đã xem
								</a></li>
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/user/address-form">
										<i class="fas fa-map-marker-alt me-2"></i>Địa chỉ giao hàng
								</a></li>
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/chat"> <i
										class="fas fa-comments me-2"></i>Tin nhắn <span
					...
					<c:otherwise>
						...
						<a href="${pageContext.request.contextPath}/auth/login"
							class="btn btn-outline"> <i class="fas fa-sign-in-alt me-1"></i>
							<span class="d-none d-md-inline">Đăng nhập</span>
						</a>
						<a href="${pageContext.request.contextPath}/auth/register"
							class="btn btn-warning"> <i class="fas fa-user-plus me-1"></i>
