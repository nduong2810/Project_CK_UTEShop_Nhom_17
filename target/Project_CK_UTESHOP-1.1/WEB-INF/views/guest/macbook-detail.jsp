...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('addToCartBtn').addEventListener('click', function() {
        ...
        const chip = document.querySelector('.variant-section:nth-of-type(1) .variant-option.active').textContent;
        const ram = document.querySelector('.variant-section:nth-of-type(2) .variant-option.active').textContent;
        alert(`Đã thêm ${quantity} MacBook Pro với ${chip} và ${ram} vào giỏ hàng!`);
    });
    ...
    document.getElementById('buyNowBtn').addEventListener('click', function() {
        ...
        const chip = document.querySelector('.variant-section:nth-of-type(1) .variant-option.active').textContent;
        const ram = document.querySelector('.variant-section:nth-of-type(2) .variant-option.active').textContent;
        alert(`Mua ngay ${quantity} MacBook Pro với ${chip} và ${ram}!`);
    });
