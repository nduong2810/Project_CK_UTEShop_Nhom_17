...
<title>UTESHOP Admin • Danh mục</title>
<link
						...
						<c:forEach var="c" items="${categories}" varStatus="i">
							<tr>
								...
								<td class="text-end"><a
									...
									href="${pageContext.request.contextPath}/admin/categories/edit?id=${c.maDM}"><i
				...
				<div class="modal-body">
					<div class="mb-3">
						<label class="form-label">Tên danh mục</label><input
							class="form-control" name="tenDM" required>
					</div>
					<div>
						<label class="form-label">Danh mục cha</label><select
							class="form-select" name="maCha"><option value="">(Không)</option>
