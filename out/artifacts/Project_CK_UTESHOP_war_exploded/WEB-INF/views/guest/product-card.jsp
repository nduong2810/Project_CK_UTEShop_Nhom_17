...
<div class="col">
    <div class="product-card">
        <div class="product-image-container">
            ...
            <c:set var="isFavorite" value="${not empty sessionScope.user && not empty favoriteProductIds && favoriteProductIds.contains(product.maSP)}" />

            <button class="btn-favorite ${isFavorite ? 'active' : ''}" 
                    onclick="toggleFavorite(event, this, ${product.maSP}, ${empty sessionScope.user})">
